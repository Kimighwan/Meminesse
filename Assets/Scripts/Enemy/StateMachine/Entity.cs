...
public class Entity : MonoBehaviour
{
    ...
    {
        entityVelocity = new Vector2(facingDirection * velocity, rigid.velocity.y);
        rigid.velocity = entityVelocity;
    }
    ...
    public virtual bool CheckLedge()                    // 낭떨어지 체크
    {
        ...
        //return Physics2D.Raycast(ledgeCheck.position, Vector.down, entityData.ledgeCheckDistance, entityData.layerMask);
    }
    ...
    // 현재는 모든 몬스터가 어느 한 위치에서 일직선으로 탐지 한다 (2025_04_02)
